...
export default function OwnerDashboardScreen({ navigation }) {
  ...
  // ✅ Check if this restaurant has analytics access
  ...
  // ── Quick actions ─────────────────────────
  // ✅ Analytics action only shows for premium
  const QUICK_ACTIONS = [
    {
      label:   'Add Menu Item',
      icon:    'add-circle',
    ...
    // ✅ Only add Analytics action if premium
    ...(analyticsEnabled ? [{
      label:   'Analytics',
      icon:    'bar-chart',
      color:   COLORS.info,
  ...
  return (
    ...
    >
      ...
      {/* ══════════════════════════════════════ */}
      {/* ANALYTICS SECTION                      */}
      {/* ✅ PREMIUM ONLY - 3 different states   */}
      {/* ══════════════════════════════════════ */}

      {/* STATE 1 — Premium: show analytics card */}
      {analyticsEnabled && (
        <TouchableOpacity
      ...
      {/* STATE 2 — Basic: teaser with upgrade prompt */}
      {currentPlanId === 'basic' && (
        <TouchableOpacity
        ...
        >
          ...
          <View style={styles.analyticsLockedMock}>
            <View style={styles.analyticsMockStat}>
              <Text style={styles.analyticsMockValue}>???</Text>
              <Text style={styles.analyticsMockLabel}>Views</Text>
            </View>
            <View style={styles.analyticsMockStat}>
              <Text style={styles.analyticsMockValue}>???</Text>
              <Text style={styles.analyticsMockLabel}>Calls</Text>
            </View>
            <View style={styles.analyticsMockStat}>
              <Text style={styles.analyticsMockValue}>???</Text>
              <Text style={styles.analyticsMockLabel}>WhatsApp</Text>
            </View>
            <View style={styles.analyticsMockStat}>
              <Text style={styles.analyticsMockValue}>??%</Text>
              <Text style={styles.analyticsMockLabel}>Conversion</Text>
            </View>
          </View>
      ...
      {/* STATE 3 — Free trial: locked banner */}
      {currentPlanId === 'free_trial' && (
        <TouchableOpacity
          style={styles.analyticsLockedCard}
          onPress={() =>
...
const styles = StyleSheet.create({
  ...
  noRestaurant: {
    ...
    padding: SIZES.xl, backgroundColor: COLORS.background,
  },
  noRestaurantTitle: {
    fontSize: FONTS.xxl, fontWeight: 'bold',
    color: COLORS.text, marginTop: SIZES.lg,
  },
  noRestaurantText: {
    fontSize: FONTS.lg, color: COLORS.textLight,
    textAlign: 'center', marginTop: SIZES.sm, marginBottom: SIZES.xl,
  },
  createBtn: {
  ...
  createBtnText: {
    color: COLORS.textWhite, fontSize: FONTS.lg, fontWeight: 'bold',
  },
  ...
  restaurantName: {
    fontSize: FONTS.xxl, fontWeight: 'bold', color: COLORS.textWhite,
  },
  planRow: {
  ...
  planName: {
    fontSize: FONTS.sm, color: 'rgba(255,255,255,0.9)', fontWeight: '600',
  },
  verifiedBadge: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: 'rgba(255,255,255,0.2)',
    paddingHorizontal: 6, paddingVertical: 2,
    borderRadius: RADIUS.round, gap: 3,
  },
  verifiedText: { fontSize: FONTS.xs, color: '#FFFFFF', fontWeight: '600' },
  ...
  subscriptionCard: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: COLORS.surface, margin: SIZES.md,
    padding: SIZES.md, borderRadius: RADIUS.xl, gap: SIZES.md, ...SHADOW,
  },
  subscriptionLeft: {
    flex: 1, flexDirection: 'row', alignItems: 'center', gap: SIZES.md,
  },
  subscriptionIconBg: {
  ...
  subscriptionStatus: { fontSize: FONTS.sm, color: COLORS.textMuted, marginTop: 2 },
  subscriptionPrice:  {
    fontSize: FONTS.sm, color: COLORS.primary, fontWeight: '600', marginTop: 2,
  },
  upgradeBtn: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: COLORS.primary,
  ...
  upgradeBtnText:   { color: '#FFFFFF', fontSize: FONTS.sm, fontWeight: 'bold' },

  // Feature preview
  featuresPreview: {
    backgroundColor: COLORS.primary + '08',
    marginHorizontal: SIZES.md, marginBottom: SIZES.md,
    padding: SIZES.md, borderRadius: RADIUS.xl,
    borderWidth: 1, borderColor: COLORS.primary + '20',
  },
  featuresPreviewTitle: {
    fontSize: FONTS.md, fontWeight: 'bold',
    color: COLORS.text, marginBottom: SIZES.sm,
  },
  featuresGrid: {
  ...
  featureItem: {
    ...
    borderRadius: RADIUS.round, gap: 6, ...SHADOW,
  },
  featureItemLabel: { fontSize: FONTS.sm, color: COLORS.text, fontWeight: '500' },
  seeAllPlansBtn:   { alignSelf: 'flex-end' },
  seeAllPlansBtnText: {
    color: COLORS.primary, fontWeight: 'bold', fontSize: FONTS.sm,
  },
  ...
  analyticsCard: {
    ...
    gap: SIZES.sm, borderWidth: 1, borderColor: COLORS.border, ...SHADOW,
  },
  analyticsCardHeader: {
  ...
  // ✅ Premium badge on analytics card
  premiumBadge: {
  ...
  premiumBadgeText: { fontSize: FONTS.xs, color: COLORS.primary, fontWeight: '700' },
  analyticsViewAll: {
    flexDirection: 'row', alignItems: 'center', gap: 2,
  },
  analyticsViewAllText: {
    fontSize: FONTS.sm, color: COLORS.primary, fontWeight: '600',
  },
  analyticsMiniGrid: {
    flexDirection: 'row', justifyContent: 'space-between',
  ...
  analyticsMiniStat: { flex: 1, alignItems: 'center', gap: 4 },
  analyticsMiniValue: { fontSize: FONTS.xl, fontWeight: 'bold', color: COLORS.text },
  analyticsMiniLabel: { fontSize: FONTS.xs, color: COLORS.textMuted },
  analyticsMinDivider: { width: 1, height: 40, backgroundColor: COLORS.border },
  viewerBreakdown: {
    flexDirection: 'row', alignItems: 'center', gap: SIZES.xs,
    paddingTop: SIZES.xs, borderTopWidth: 1, borderTopColor: COLORS.divider,
  },
  viewerBreakdownText: {
    fontSize: FONTS.xs, color: COLORS.textMuted, fontStyle: 'italic', flex: 1,
  },

  // ✅ Analytics locked card (Free trial + Basic)
  analyticsLockedCard: {
    marginHorizontal: SIZES.md, marginBottom: SIZES.md,
  ...
  analyticsMockValue: {
    ...
    color: COLORS.border,  // ✅ greyed out
  },
  analyticsMockLabel: { fontSize: FONTS.xs, color: COLORS.border },

  // ✅ Lock overlay on top of mock stats
  analyticsLockOverlay: {
    backgroundColor: 'rgba(44,62,80,0.92)',
    padding: SIZES.lg, alignItems: 'center', gap: SIZES.sm,
  },
  analyticsLockTitle: {
    fontSize: FONTS.xl, fontWeight: 'bold', color: '#FFFFFF',
    textAlign: 'center',
  },
  analyticsLockDesc: {
  ...
  analyticsUpgradeChip: {
    ...
    borderRadius: RADIUS.round, marginTop: SIZES.xs,
  },
  analyticsUpgradeChipText: {
    color: '#FFFFFF', fontWeight: 'bold', fontSize: FONTS.sm,
  },

  // Stats
  sectionTitle: {
    fontSize: FONTS.xl, fontWeight: 'bold', color: COLORS.text,
    paddingHorizontal: SIZES.md, paddingTop: SIZES.sm, marginBottom: SIZES.sm,
  },
  statsGrid: {
    flexDirection: 'row', flexWrap: 'wrap',
    paddingHorizontal: SIZES.md, gap: SIZES.md, marginBottom: SIZES.md,
  },
  statCard: {
    flex: 1, minWidth: '45%', backgroundColor: COLORS.surface,
    borderRadius: RADIUS.lg, padding: SIZES.md, alignItems: 'center', ...SHADOW,
  },
  statIcon: {
  ...
  actionCard: {
    flex: 1, minWidth: '45%', backgroundColor: COLORS.surface,
    borderRadius: RADIUS.lg, padding: SIZES.lg, alignItems: 'center', ...SHADOW,
  },
  actionIcon: {
  ...
  actionLabel: {
    fontSize: FONTS.md, fontWeight: '600',
  ...
  lockedFeature: {
    ...
    borderRadius: RADIUS.lg, marginBottom: SIZES.sm, gap: SIZES.md, ...SHADOW,
  },
  lockedIconBg: {
  ...
  upgradeCTA: {
    ...
    borderRadius: RADIUS.lg, gap: SIZES.sm,
    marginTop: SIZES.sm, marginBottom: SIZES.md, ...SHADOW,
  },
  upgradeCTAText: { color: '#FFFFFF', fontSize: FONTS.md, fontWeight: 'bold' },
});